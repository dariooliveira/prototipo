...
count = 0
Dir.glob('/mnt/cpdoc/dhbb/json/*.json') do |js_file|
  ...
  json["id"]="dhbb" + File.basename(js_file,".json")
  json["url"]="http://nlp.emap.fgv.br/cpdoc/dhbb/"+File.basename(js_file,".json")+".html"
  solr.add json
  solr.commit
  puts count = count+1
